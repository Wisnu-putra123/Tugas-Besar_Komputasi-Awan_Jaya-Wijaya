...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
    <h2 class="text-2xl font-bold text-slate-800 mb-6">Detail Tugas</h2>
    ...
    <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="space-y-5">
        ...
        <div class="flex justify-end space-x-3 pt-4 border-t border-slate-100">
            ...
            <button type="submit" class="px-5 py-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition font-medium">Perbarui Tugas</button>
        </div>
    </form>
</div>
@endsection